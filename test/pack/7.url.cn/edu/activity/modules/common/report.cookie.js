 ...
 *                                              '_BASE':{}
 *                                              '1' : {
 *                                                  'uin':'','ts':'','opername':'','module':'','action':'','obj1':'',
 *                                                  'obj2':'','obj3':'','action':'','ver1':'','ver2':'','ver3':'','ver4':''}，这里ts表示时间戳，不传使用服务器时间戳，objs表示用户ip，也不需要传
 *                                          }
 *                                      }
